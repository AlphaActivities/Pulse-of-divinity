...
export default function ArchiveNavbar({ onNavigateHome }: Props) {
  ...
  return (
    <>
      {/* ── Bar ── */}
      <nav
        className="fixed top-0 left-0 right-0 z-50 glass-nav py-3 transition-[background,border-color,box-shadow,backdrop-filter,-webkit-backdrop-filter] duration-500"
              ...
              <li key={item.label}>
                <button
                  ...
                  style={{
                    ...
                    letterSpacing: '0.2em',
                    textTransform: 'uppercase',
                    color: scrolled ? '#6b5143' : 'rgba(62,34,64,0.72)',
                    background: 'none',
                    border: 'none',
                    cursor: 'pointer',
                    padding: '6px 0',
            ...
            {[0, 1, 2].map((i) => (
              <span
                ...
                style={{
                  ...
                  height: '1.5px',
                  background: menuOpen ? '#3e2240' : '#3e2240',
                  margin: '3px 0',
      ...
      >
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
          {/* Back to home as first item */}
          <li style={{ borderBottom: '1px solid rgba(201,162,39,0.1)' }}>
            <button
              onClick={() => handleNav('/')}
              style={{
                display: 'block',
